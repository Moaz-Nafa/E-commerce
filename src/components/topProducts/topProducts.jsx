...
import img4 from '../../assets/shirt/pro15.png'
import img5 from '../../assets/shirt/pro2.png'
import img6 from '../../assets/shirt/pro16.png'
...
{/* Body section */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center">
            {ProductsData.map((data) => (
              <div
                data-aos="zoom-in" 
                className="rounded-2xl bg-white dark:bg-gray-800 mb-24 hover:bg-black/80
