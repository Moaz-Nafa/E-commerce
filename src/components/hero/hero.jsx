...
import img2 from '../../assets/hero/hero14.png'
import img3 from '../../assets/hero/heo13.png'
...
{/* text content section */}
          ...
          sm:text-left order-2 sm:order-1 relative z-10">
            ...
            <p              
              data-aos="fade-up" data-aos-duration="500" data-aos-delay="100" className="text-sm">
              {data.description}        
            </p>
            <div
...
{/* image section */}
              ...
              <div data-aos="zoom-in" className="relative z-10">
                <img src={data.img} alt="" className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] 
                sm:scale-105 lg:scale-120 object-contain mx-auto"/>   
              </div>
              </div>
            </div>
{/* end of all slider content */}
          </>
          ))}
        </Slider>
      </div>
